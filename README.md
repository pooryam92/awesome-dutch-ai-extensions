...
| [wefact-mcp (CodeMill)](https://github.com/CodeMill-Solutions/wefact-mcp) | Work a WeFact administration across all 17 API controllers — invoices, subscriptions, bank transactions and CRM — writes and customer emails each need an opt-in; installs from a clone, not npm. | WeFact | ![MCP · Community](assets/badges/tags-mcp-community.svg) |
